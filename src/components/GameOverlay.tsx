...
import { playGameOver, playWaveStart } from '../audio/sfxManager'
...
export function GameOverlay() {
  ...
  useEffect(() => {
    ...
    if (gamePhase === 'gameover' && prev !== 'gameover') {
      playGameOver()
    }
    // Wave start: transitioning into playing from idle (first wave) or wave-clear (next wave)
    if (gamePhase === 'playing' && (prev === 'idle' || prev === 'wave-clear')) {
      playWaveStart()
    }
  }, [gamePhase])
