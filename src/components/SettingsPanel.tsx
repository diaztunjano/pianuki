        ...
        <div className="flex flex-col gap-3">
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              style={{ flexGrow: 0, paddingLeft: '1.5rem', paddingRight: '1.5rem' }}
            ...
            <input
              ...
              className="flex-1 accent-white cursor-pointer disabled:opacity-40 disabled:cursor-not-allowed"
            />
          ...
          <p className="text-xs text-white/40">
            Muting SFX does not affect microphone input.
          </p>
        </div>
